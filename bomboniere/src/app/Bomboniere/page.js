...
import Link from "next/link"; // Manter o Link se for usado em outros lugares
...
export default function MenuLoja() {
  ...
  // Função para lidar com o clique do botão "Menu Principal"
  ...
  return (
    <div className={styles.menuLoja}>
      ...
      <footer className={styles.footer}>
        ...
        {/* Botão corrigido para usar useRouter */}
        <button className={styles.button} onClick={handleMenuPrincipalClick}>
          Menu Principal
        </button>
      </footer>
    </div>
